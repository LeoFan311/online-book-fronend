import { Col, Divider, InputNumber, Row, Empty, Steps, Form, Input, Checkbox, Result, Button, message } from 'antd';
                    ...
                    <div style={{ background: '#fff', width: '100%', padding: '16px', borderRadius: '4px' }}>
                        <Result
                            ...
                            extra={[
                                ...
                                //     Go Console
                                // </Button>,
                                <Button key="buy">View purchase history</Button>,
                            ]}
                        />
                    </div>
                </Row>
                                ...
                                return (
                                    <div className="order-book" key={index}>
                                        ...
                                        <div className="action">
                                            ...
                                            <div className="sum">{`Total: ${new Intl.NumberFormat('vi-VN', {
                                                style: 'currency',
                                                currency: 'VND',
                        ...
                        <div className="order-sum">
                            {currentStep === 1 && (
                                <Form form={form} onFinish={onFinish}>
                                    ...
                                    <Form.Item labelCol={{ span: 24 }} name="payMethod" label="Payment method">
                            ...
                            <Divider style={{ margin: '10px 0' }} />
                            <button onClick={() => form.submit()}>Buy</button>
                        </div>
                    </Col>
                </Row>
            )}
