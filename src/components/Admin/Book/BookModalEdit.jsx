                ...
                <div className="modal-add-book-children">
                    ...
                    >
                        ...
                        <div className="flex_50">
                            ...
                            <Form.Item
                                ...
                                rules={[
                                    {
                                        required: true,
                                        message: 'Please fill the book title!',
                                    },
                                ]}
                            >
                                <Input />
                        ...
                        <div className="flex_25">
                            ...
                            <Form.Item
                                ...
                                rules={[
                                    {
                                        required: true,
                                        message: 'Please fill sold quantity',
                                    },
                                ]}
                            >
                                <InputNumber min={0} />
                        ...
                        <div className="upload-thumbnail" style={{ display: 'flex' }}>
                            ...
                            <Form.Item labelCol={{ span: 24 }} label="Slider Images" name="slider">
                                <Upload
                                    multiple
                                    name="slider"
                                    listType="picture-card"
